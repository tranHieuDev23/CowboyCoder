...
_Phần trước: [\[C++ Cơ bản\] Phần 3: Thiết lập môi trường làm việc - Giới thiệu về Code::Blocks](http://cowboycoder.vercel.app/article/c-co-ban-phan-3-thiet-lap-moi-truong-lam-viec-gioi-thieu-ve-codeblocks)_
...
/_ Hàm main() là nơi chương trình được thực hiện _/
...
_Phần sau: [\[C++ Cơ bản\] Phần 5: Biến và kiểu dữ liệu](http://cowboycoder.vercel.app/article/c-co-ban-phan-5-bien-va-kieu-du-lieu)_
