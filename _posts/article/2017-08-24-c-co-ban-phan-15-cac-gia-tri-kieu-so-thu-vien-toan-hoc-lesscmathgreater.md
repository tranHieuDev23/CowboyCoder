...
_Phần trước: [\[C++ Cơ bản\] Phần 14: Mảng - Array](http://cowboycoder.vercel.app/article/c-co-ban-phan-14-mang-array)_
...
int main()
{
cout << 300000 _ 200000 << endl;
cout << 300000ll _ 200000 << endl;
return 0;
}
{% endhighlight %}
...
{% highlight c++ %}
10 /_ int _/
10ll /_ long long int _/
10u /_ unsigned int _/
10ull /_ unsigned long long int _/
{% endhighlight %}
...
{% highlight c++ %}
cout << 072 << endl; /_ Bát phân _/
cout << 0xA << endl; /_ Thập lục phân _/
{% endhighlight %}
...
{% highlight c++ %}
10.0 /_ biểu diễn đúng, giá trị kiểu double _/
10.0f /_ biểu diễn đúng, giá trị kiểu float _/
.01 /_ biểu diễn đúng, giá trị kiểu double và bằng 0.01 _/
21f /_ biểu diễn sai, không có dấu chấm và phần thập phân _/
21.f /_ biểu diễn đúng, giá trị kiểu float và bằng 21.0 _/
{% endhighlight %}
...
{% highlight c++ %}
314e-3 /_ biểu diễn đúng, giá trị bằng 3.14 _/
.01E2 /_ biểu diễn đúng, giá trị bằng 1 _/
e10 /_ biểu diễn sai, thiếu cả phần nguyên và phần thập phân. _/
{% endhighlight %}
...
_Phần sau: [\[C++ Cơ bản\] Phần 16: Các giá trị kiểu kí tự. Xâu kí tự.](http://cowboycoder.vercel.app/article/c-co-ban-phan-16-cac-gia-tri-kieu-ki-tu-xau-ki-tu)_
